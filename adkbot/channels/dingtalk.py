...
from adkbot.config.schema import Base
...
class AdkBotDingTalkHandler(CallbackHandler):
    """
    Standard DingTalk Stream SDK Callback Handler.
    Parses incoming messages and forwards them to the AdkBot channel.
    """
    ...
    async def process(self, message: CallbackMessage):
        ...
        try:
            ...
            # Forward to AdkBot via _on_message (non-blocking).
...
class DingTalkChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = AdkBotDingTalkHandler(self)
    ...
    async def _send_markdown_text(self, token: str, chat_id: str, content: str) -> bool:
        return await self._send_batch_message(
            ...
            chat_id,
            "sampleMarkdown",
            {"text": content, "title": "AdkBot Reply"},
        )
    ...
    async def _on_message(
        ...
        """Handle incoming message (called by AdkBotDingTalkHandler).
    ...
    async def _download_dingtalk_file(
        ...
        from adkbot.config.paths import get_media_dir
