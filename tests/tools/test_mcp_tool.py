...
from adkbot.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from adkbot.agent.tools.registry import ToolRegistry
from adkbot.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("adkbot.agent.tools.mcp.logger.warning", _warning)
