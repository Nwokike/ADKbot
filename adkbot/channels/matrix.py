...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install adkbot[matrix]"
    ) from e
...
from adkbot.config.paths import get_data_dir, get_media_dir
from adkbot.config.schema import Base
from adkbot.utils.helpers import safe_filename
